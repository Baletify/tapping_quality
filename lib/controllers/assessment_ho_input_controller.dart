...
class AssessmentHoInputController extends GetxController {
  var selectedWound = ''.obs;
  var selectedDepth = ''.obs;
  var isTeknik1Checked = false.obs;
  var isTeknik2Checked = false.obs;
  var isTeknik3Checked = false.obs;
  var isTeknik4Checked = false.obs;
  ...
  void fetchAssessmentDetails() async {
    final service = AssessmentInputHoService();
  ...
  void resetState() {
    ...
    isTeknik1Checked.value = false;
    isTeknik2Checked.value = false;
    isTeknik3Checked.value = false;
    isTeknik4Checked.value = false;
  }
  ...
  void toggleCheckbox5(String teknik) {
    switch (teknik) {
      case 'Q1':
        isTeknik1Checked.value = !isTeknik1Checked.value;
        if (isTeknik1Checked.value && isTeknik4Checked.value) {
          isTeknik4Checked.value = false;
        }
        break;
      case 'Q2':
        isTeknik2Checked.value = !isTeknik2Checked.value;
        if (isTeknik2Checked.value && isTeknik4Checked.value) {
          isTeknik4Checked.value = false;
        }
        break;
      case 'Q3':
        isTeknik3Checked.value = !isTeknik3Checked.value;
        if (isTeknik3Checked.value && isTeknik4Checked.value) {
          isTeknik4Checked.value = false;
        }
        break;
      case 'Q4':
        isTeknik4Checked.value = !isTeknik4Checked.value;
        if (isTeknik4Checked.value) {
          isTeknik1Checked.value = false;
          isTeknik2Checked.value = false;
          isTeknik3Checked.value = false;
        }
