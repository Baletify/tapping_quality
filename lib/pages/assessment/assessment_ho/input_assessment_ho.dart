...
import 'package:tapping_quality/services/assessment_input_ho_service.dart';

class InputAssessmentHo extends StatefulWidget {
  final int assessmentDetailId;
  final dynamic inspectionDate;
  final String? nikPenyadap;
  const InputAssessmentHo({
    super.key,
  ...
  @override
  State<InputAssessmentHo> createState() => _InputAssessmentHoState();
}

class _InputAssessmentHoState extends State<InputAssessmentHo> {
  final AssessmentHoInputController controller = Get.put(
  ...
  final service = Get.put(AssessmentInputHoService());
  ...
  bool isQ12Answered() =>
      controller.isTeknik1Checked.value ||
      controller.isTeknik2Checked.value ||
      controller.isTeknik3Checked.value ||
      controller.isTeknik4Checked.value;
  ...
  selectAngleRadioBtn(int treeIndex, int selectedId) {
    final angleID = [23, 24, 25]; // all possible IDs for this question
    controller.selectedCriteriaIds[treeIndex - 1].removeWhere(
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              'Teknik Penyadapan Panel Atas - Bisa Pilih Lebih dari 1',
                              style: TextStyle(
                                fontFamily: 'Poppins',
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Obx(
                                    () => CheckboxListTile(
                                      title: const Text(
                                        'Tidak menggunakan gagang pisau panjang',
                                        style: TextStyle(
                                          fontFamily: 'Poppins',
                                          fontSize: 12,
                                      ...
                                      value: controller.isTeknik1Checked.value,
                                      onChanged: (value) {
                                        controller.toggleCheckbox5('Q1');
                                ...
                                Container(
                                  ...
                                  child: Obx(
                                    () => CheckboxListTile(
                                      title: const Text(
                                        'Tidak menggunakan pisau sodhok (HO)',
                                        style: TextStyle(
                                          fontFamily: 'Poppins',
                                          fontSize: 12,
                                          fontWeight: FontWeight.w400,
                                      ...
                                      value: controller.isTeknik2Checked.value,
                                      onChanged: (value) {
                                        controller.toggleCheckbox5('Q2');
                                        checkAndAdvanceQuestion(
                                          1,
                                          isQ12Answered(),
                                        );
                                ...
                                Container(
                                  ...
                                  child: Obx(
                                    () => CheckboxListTile(
                                      title: const Text(
                                        'Sadapan tidak dishodok/ditarik',
                                        style: TextStyle(
                                          fontFamily: 'Poppins',
                                          fontSize: 12,
                                          fontWeight: FontWeight.w400,
                                      ...
                                      value: controller.isTeknik3Checked.value,
                                      onChanged: (value) {
                                        controller.toggleCheckbox5('Q3');
                                        checkAndAdvanceQuestion(
                                          1,
                                          isQ12Answered(),
                                        );
                                ...
                                Container(
                                  ...
                                  child: Obx(
                                    () => CheckboxListTile(
                                      title: const Text(
                                        'Teknik Penyadapan Panel Atas Sudah sesuai',
                                        style: TextStyle(
                                          fontFamily: 'Poppins',
                                          fontSize: 12,
                                          fontWeight: FontWeight.w400,
                                      ...
                                      value: controller.isTeknik4Checked.value,
                                      onChanged: (value) {
                                        controller.toggleCheckbox5('Q4');
                                        checkAndAdvanceQuestion(
                                          1,
                                          isQ12Answered(),
                                        );
                                  ...
                                  child: Obx(
                                    () => RadioListTile<String>(
                                      ...
                                      onChanged: (value) {
                                        ...
                                        if (value == '> 45 derajat') {
                                          selectAngleRadioBtn(treeIndex, 23);
                                        } else if (value == '< 45 derajat') {
                                          selectAngleRadioBtn(treeIndex, 24);
                                        } else if (value == '45 derajat') {
                                          selectAngleRadioBtn(treeIndex, 25);
                                        }
                                      },
